 ...
 *
 * <ul>
 * <li>{@code aurumcoin:<address>}</li>
 * <li>{@code aurumcoin:<address>?<name1>=<value1>&<name2>=<value2>} with multiple
...
public class BitcoinURI {
    ...
    public static final String BITCOIN_SCHEME = "aurumcoin";
    ...
    public BitcoinURI(@Nullable NetworkParameters params, String input) throws BitcoinURIParseException {
        ...
        // URI is formed as  aurumcoin:<address>?<query parameters>
        // blockchain.info generates URIs of non-BIP compliant form aurumcoin://address?....
        ...
        // For instance with : aurumcoin:129mVqKUmJ9uwPxKJBnNdABbuaaNfho4Ha?amount=0.06&label=Tom%20%26%20Jerry
        // the & (%26) in Tom and Jerry gets interpreted as a separator and the label then gets parsed
        // as 'Tom ' instead of 'Tom & Jerry')
        String schemeSpecificPart;
        if (input.startsWith("aurumcoin://")) {
            schemeSpecificPart = input.substring("aurumcoin://".length());
        } else if (input.startsWith("aurumcoin:")) {
            schemeSpecificPart = input.substring("aurumcoin:".length());
	} else if (input.startsWith("aurum:")) {
            schemeSpecificPart = input.substring("aurum:".length());
        } else {
        ...
        if (addressSplitTokens.length == 0)
            throw new BitcoinURIParseException("No data found after the aurumcoin: prefix");
