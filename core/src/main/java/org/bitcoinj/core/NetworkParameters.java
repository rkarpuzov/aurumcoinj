...
public abstract class NetworkParameters implements Serializable {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            byte[] bytes = Utils.HEX.decode
                    ("04ffff001d01040d4d74676f7820697320646f776e");
    ...
    public static final int TARGET_TIMESPAN1 = 18000;  // 3 hours per difficulty cycle, on average. old one
    public static final int TARGET_TIMESPAN2 = 120;    // 2 minutes. new timespan
    public static final int PowRetargetBlockStart = 1086560;
